function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "/keno_assets/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "/keno_assets/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "/keno_assets/sprites/but_start.png");
